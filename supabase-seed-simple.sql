-- Simplified Supabase Seed Script
-- Instructions:
-- 1. Go to Authentication > Users in Supabase Dashboard
-- 2. Create a user with email: demo@empresa.cl and password: DemoPass123!
...
BEGIN
  ...
  IF v_user_id = 'YOUR_USER_UUID_HERE' THEN
    RAISE EXCEPTION 'Please replace YOUR_USER_UUID_HERE with the actual user UUID from auth.users table';
  END IF;
